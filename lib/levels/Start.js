...
class LevelStart extends Level {
  constructor () {
    ...
    this.players[0].x = 375
    this.players[0].y = 300

    this.players[1].x = 175
    this.players[1].y = 300

    this.players[2].x = 575
    this.players[2].y = 300
  }

  render (ctx) {
    super.render(ctx)

    ctx.fillStyle = '#58c72c80'
    ctx.fillRect(485, 200, 65, 300)
  }
}
